...
##### Linear regression
```{r}
imdb <- read_csv("https://raw.githubusercontent.com/MJHeaton/IMDB/master/CleanedIMDBData.csv")
```
...
## gradient Boosting
```{r}
tune.grid = expand.grid(n.trees = seq(195, 205, 1),
                        interaction.depth = seq(3.5, 5.5, .5),
                        shrinkage = .16,
                        n.minobsinnode = seq(14, 17, 1))
